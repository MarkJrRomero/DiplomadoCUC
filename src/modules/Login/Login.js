    ...
    return (
      <div className="Login">
        ...
        <form className="login-form">
          ...
          <a className="text-center" href="/Registrar">No tienes cuenta? Regístrate aquí!</a>
          <button type="button" onClick={sigInEmail}>LOGIN</button>
          <button className="p-2" style={{backgroundColor: "red"}} onClick={sigIn} type="button">INGRESAR CON GOOGLE</button>
        </form>
      </div>
      </div>
    );
